...
| GET      | /api/players/summary     | -                            | 200 OK [PlayerSummaryDTO]             | Any                 |
...
| POST     | /api/comments/player/:id | id, {CommentRequestDTO}      | 201 Created {Comment}                 | Any                 |
| DELETE   | /api/comments/:id        | id                           | 204 No Content                        | Admin               |
| GET      | /api/dream-teams         | -                            | 200 OK [DreamTeamWithPlayersDTO]      | Authenticated/Admin |
| POST     | /api/dream-teams         | -                            | 201 Created {DreamTeamWithPlayersDTO} | Authenticated/Admin |
